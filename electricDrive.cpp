...
ElectricDrive::ElectricDrive(int x)
{
    ...
    // this->motor_back_right = new MotorCtrl(ed_pin_wPi_cfg::BACK_RIGHT::PIN_IN_2,
    //     ed_pin_wPi_cfg::BACK_RIGHT::PIN_IN_1, ed_pin_wPi_cfg::BACK_RIGHT::PIN_PWM);
...
{
    this->motor_back_left->speedUp(10);
    this->motor_back_left->forward();

    // this->motor_back_right->speedUp(15);
    // this->motor_back_right->forward();

    // this->motor_front_left->speedUp(15);
    // this->motor_front_left->forward();

    // this->motor_front_right->speedUp(15);
...
{
    // this->motor_front_right->speedUp(75);
    // this->motor_front_right->forward(); 
    ...
    // this->motor_back_right->speedUp(55);
    // this->motor_back_right->forward();
}

void ElectricDrive::moveRight(void)
{
    // this->motor_front_left->speedUp(75);
    // this->motor_front_left->forward();
